...
const BuildTab = () => {
    return (
        <div className={styles.sideWrapper}>
            <div className={styles.sideTitle}>Services</div>
            <div className={styles.firstSideMenu}>
                <a to="/categories/photos-and-videos">
                    <svg fill="black"  viewBox="0 0 512 512"
                         xmlns="http://www.w3.org/2000/svg"><title>ionicons-v5-h</title>
                        <path
